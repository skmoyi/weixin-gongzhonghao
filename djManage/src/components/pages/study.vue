	...
	<div id="fuwu">
		...
		<div class="table-wrapper">
			...
			<el-table v-loading="tableFlag" :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
				...
				<el-table-column prop="studyTitle" label="标题" show-overflow-tooltip></el-table-column>
				<!--<el-table-column prop="activityContent" label="内容" width="140"></el-table-column>-->
				<el-table-column prop="studyTime" label="创建时间"></el-table-column>
		...
		<el-dialog :visible.sync="flag" :before-close="clearList">
			<el-form :label-position="labelPosition" label-width="100px" :model="list">
				<el-form-item label="标题">
					<el-input v-model="list.studyTitle" placeholder="请输入标题"></el-input>
				</el-form-item>
				<el-form-item label="内容">
					...
					<quill-editor v-model="list.studyContent" ref="myQuillEditor" :options="editorOption" @change="onEditorChange($event)">
					</quill-editor>
				...
				<el-form-item label="学习时间">
					<el-input type='date' v-model="list.studyTime" placeholder="学习时间" value-format="yyyy-MM-dd"></el-input>
				</el-form-item>
		...
		<el-dialog :visible.sync="addFlag" :before-close="clearList">
			...
			<el-form :label-position="labelPosition" label-width="100px" :model="list">
				...
				<el-form-item label="学习时间：">
					...
					<el-date-picker v-model="list.studyTime" type="date" placeholder="学习时间" value-format="yyyy-MM-dd">
					</el-date-picker>
				</el-form-item>
		...
		<el-dialog :visible.sync="lookFlag">
			...
			{{value.studyTitle}}
				...
				<div class="time">{{value.studyTime}}</div>
				...
				<div class="content" v-html="value.studyContent">
					{{value.studyContent}}
				</div>
			</div>
		</el-dialog>
...
<script>
	...
	export default {
		...
		methods: {
			...
			edit() {
				let TOKEN = Cookies.get('ADMINTOKEN') || '';
				$http.post(URL.updStudy, this.list, {
						dataType: "JSON",
						headers: {
			...
			submit() {
				...
				if(this.$refs.uploadImages.uploadFiles) {
				...
				$http.post(URL.addStudy, this.list, {
						dataType: "JSON",
						headers: {
							"Content-Type": "application/json;charsetset=UTF-8",
							"Authorization": TOKEN
